...
extern const float g_side_quad_triangles[SIDE_COUNT][6];

//extern const unsigned int g_side_coord[SIDE_COUNT];
//extern const unsigned int g_side_sign[SIDE_COUNT];

extern const Vector3 g_side_normals[SIDE_COUNT];
extern const float g_side_tangents[SIDE_COUNT][4];

extern const float g_side_corners[SIDE_COUNT][4];
extern const float g_side_edges[SIDE_COUNT][4];

extern const Vector3 g_corner_inormals[CORNER_COUNT];

extern const Vector3 g_edge_inormals[EDGE_COUNT];

extern const float g_edge_corners[EDGE_COUNT][2];

const unsigned int MOORE_NEIGHBORING_3D_COUNT = 26;
extern const Vector3 g_moore_neighboring_3d[MOORE_NEIGHBORING_3D_COUNT];

const unsigned int MOORE_AREA_3D_COUNT = 27;
const unsigned int MOORE_AREA_3D_CENTRAL_INDEX = 13;
extern const Vector3 g_ordered_moore_area_3d[MOORE_AREA_3D_COUNT];
